...
<title>Matrix Admin</title><meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="{{asset('adminassets/css/matrix-login.css') }}" />
    ...
    <body>
        ...
        @endif
        <form class="form-vertical" role="form" method="post" action="{{ url('admin/store') }}">{{ csrf_field() }}
				 <div class="control-group normal_text"> <h3>Welcome </h3></div>
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="{{url('register')}}" class="flip-link btn btn-info" id="to-recover">Register</a></span>
        ...
        <script src="{{asset('adminassetsjs/matrix.login.js') }}"></script> 
